...
public class Controller {
    ...
    private static final double DISCOUNT_SUM = 20;
     ...
     * @throws se.KTH.seminar3.integration.InventoryHandler.InvalidItemBarcodeException
     */
    ...
    public String applyDiscount(double runningTotal) throws ConnectionToDatabaseFailed {
        ...
        if (runningTotal > 200) {
            discount = new StrategyDiscountPercent(DISCOUNT_PERCENT);
            discountMessage = "Applying " + DISCOUNT_PERCENT + "% discount to sale";
        } else {
            discount = new StrategyDiscountSum(DISCOUNT_SUM);
            discountMessage = "Applying a sum discount of " + DISCOUNT_SUM + " SEK to the sale";
        }
