 ...
 * Classes implementing this interface should provide their own implementation of the calculateDiscount method.
 */
public interface StrategyDiscount {

    /**
     * Calculates the discounted price based on the total price and a list of items.
     * The exact discount calculation is determined by the classes implementing this interface.
     *
