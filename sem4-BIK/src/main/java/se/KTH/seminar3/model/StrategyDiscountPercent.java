...
public class StrategyDiscountPercent implements StrategyDiscount {
    ...
    /**
     * Constructs a new StrategyDiscountPercent object with the specified
     * discount percentage.
     *
     * @param percent the percentage to be discounted from the total price
     */
    public StrategyDiscountPercent(double percent) {
